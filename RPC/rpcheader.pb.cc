...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::RPC::RpcHeader, message_type_),
  PROTOBUF_FIELD_OFFSET(::RPC::RpcHeader, ip_),
  PROTOBUF_FIELD_OFFSET(::RPC::RpcHeader, port_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpcheader_2eproto = {
  false, false, descriptor_table_protodef_rpcheader_2eproto, "rpcheader.proto", 153,
...
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  ::memcpy(&args_size_, &from.args_size_,
    ...
    reinterpret_cast<char*>(&args_size_)) + sizeof(port_));
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcHeader::_InternalSerialize(
  ...
  if (this->message_type() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(4, this->_internal_message_type(), target);
  }
...
void RpcHeader::InternalSwap(RpcHeader* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RpcHeader, port_)
      + sizeof(RpcHeader::port_)
