...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::_internal_message_type() const {
  return message_type_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::message_type() const {
  // @@protoc_insertion_point(field_get:RPC.RpcHeader.message_type)
  return _internal_message_type();
}
inline void RpcHeader::_internal_set_message_type(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  message_type_ = value;
}
inline void RpcHeader::set_message_type(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_message_type(value);
  // @@protoc_insertion_point(field_set:RPC.RpcHeader.message_type)
}

// bytes ip = 5;
inline void RpcHeader::clear_ip() {
  ip_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& RpcHeader::ip() const {
  // @@protoc_insertion_point(field_get:RPC.RpcHeader.ip)
  return _internal_ip();
}
inline void RpcHeader::set_ip(const std::string& value) {
  _internal_set_ip(value);
  // @@protoc_insertion_point(field_set:RPC.RpcHeader.ip)
}
inline std::string* RpcHeader::mutable_ip() {
  // @@protoc_insertion_point(field_mutable:RPC.RpcHeader.ip)
  return _internal_mutable_ip();
}
inline const std::string& RpcHeader::_internal_ip() const {
  return ip_.Get();
}
inline void RpcHeader::_internal_set_ip(const std::string& value) {
  
  ip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void RpcHeader::set_ip(std::string&& value) {
  
  ip_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:RPC.RpcHeader.ip)
}
inline void RpcHeader::set_ip(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  ip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:RPC.RpcHeader.ip)
}
inline void RpcHeader::set_ip(const void* value,
    size_t size) {
  
  ip_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:RPC.RpcHeader.ip)
}
inline std::string* RpcHeader::_internal_mutable_ip() {
  
  return ip_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* RpcHeader::release_ip() {
  // @@protoc_insertion_point(field_release:RPC.RpcHeader.ip)
  return ip_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void RpcHeader::set_allocated_ip(std::string* ip) {
  if (ip != nullptr) {
  ...
  ip_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ip,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:RPC.RpcHeader.ip)
}
inline std::string* RpcHeader::unsafe_arena_release_ip() {
  // @@protoc_insertion_point(field_unsafe_arena_release:RPC.RpcHeader.ip)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return ip_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RpcHeader::unsafe_arena_set_allocated_ip(
    std::string* ip) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (ip != nullptr) {
  ...
  ip_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ip, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:RPC.RpcHeader.ip)
}

// uint32 port = 6;
inline void RpcHeader::clear_port() {
  port_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::_internal_port() const {
  return port_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::port() const {
  // @@protoc_insertion_point(field_get:RPC.RpcHeader.port)
  return _internal_port();
}
inline void RpcHeader::_internal_set_port(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  port_ = value;
}
inline void RpcHeader::set_port(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_port(value);
  // @@protoc_insertion_point(field_set:RPC.RpcHeader.port)
}
